...
function ProcesoSingle({ proceso, onBack, onEdit, onDelete, onViewObjetivos }) {
        ...
        <div className="col-span-2 space-y-6">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Gestiona los objetivos de calidad asociados directamente a este proceso.
            </p>
            <Button 
              onClick={() => onViewObjetivos(proceso)}
              className="w-full"
            >
